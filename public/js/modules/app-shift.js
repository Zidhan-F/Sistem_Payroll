...
function calculateShiftDuration() {
    ...
    if (startTimeStr && endTimeStr) {
        ...
        document.getElementById('shiftSchemeDuration').value = parseFloat(durationHours.toFixed(2));
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (startInput && endInput) {
        startInput.addEventListener('input', calculateShiftDuration);
        endInput.addEventListener('input', calculateShiftDuration);
    }
});
