            ...
            <div class="modal-body" style="padding: 25px; max-height: 70vh; overflow-y: auto;">
                ...
                <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                    <div class="form-group">
                        ...
                        <input type="text" id="empEmployId" readonly placeholder="Otomatis terisi" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #ddd; outline: none; font-size: 14px; background: #f1f5f9; color: #475569; font-weight: 700; letter-spacing: 1px;">
                    </div>
                    <div class="form-group">
